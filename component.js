...
(function() {
  var Component, React, extractAndMerge, extractInto, extractMethods, getFnName, handleMixins, handlePropTypes, keyBlacklist, nameParser, tag,
  ...
  Component = (function() {
    ...
    _fn = function(tagName) {
      return Component.prototype[tagName] = tag.bind(Component, tagName);
    };
